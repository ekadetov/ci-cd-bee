...
@click.option(
    "--repo",
    default=None,
    help="The repository to use (format: user/repo)",
    required=True,
    type=str,
)
@click.option("--issue", default=None, help="The issue number", required=True, type=int)
@click.option(
    "--comment", default=None, help="The comment to post", required=False, type=str
)
...
@click.option(
    "--project",
    default=None,
    help="The project to use (format: user/repo)",
    required=True,
    type=str,
)
@click.option(
    "--issue", default=None, help="The issue number", required=False, type=int
)
@click.option(
    "--mergerequest",
    default=None,
    help="The merge request number",
    required=False,
    type=int,
)
@click.option(
...
@click.option(
    "--source",
    default=None,
    help="The name of the source branch of the merge request",
    required=False,
    type=str,
)
...
@click.option(
    "--diff",
    default=None,
    help="Path to the Git diff to comment on",
    required=True,
    type=str,
)
